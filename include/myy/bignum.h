...
//大端存储，高64位存在低索引，低64位存在高索引
#define	BN_256_LEN	4
#define	BN_288_LEN	5
#define	BN_512_LEN	8

typedef	uint64_t	BN_UNIT;
typedef	uint64_t	BN_256[BN_256_LEN];
typedef	uint64_t	BN_288[BN_288_LEN];
typedef	uint64_t	BN_512[BN_512_LEN];
typedef	uint64_t*	BN_256_ptr;
typedef	uint64_t*	BN_288_ptr;
typedef	uint64_t*	BN_512_ptr;

#define	BN_UNIT_LEN	64

/**
 * 以下宏用于大数的静态初始化
*/

#define	BN_256_INIT(a,b,c,d,e,f,g,h)					{0x##a##b##U,0x##c##d##U,0x##e##f##U,0x##g##h##U}
#define	BN_512_INIT(A,B,C,D,E,F,G,H,a,b,c,d,e,f,g,h)	{0x##A##B##U,0x##C##D##U,0x##E##F##U,0x##G##H##U,0x##a##b##U,0x##c##d##U,0x##e##f##U,0x##g##h##U}
#define	BN_256_ZERO										{0,0,0,0}
#define	BN_256_ONE										{0,0,0,1}
#define	BN_256_TWO										{0,0,0,2}

/**
 * 以下是在大数中节取部分的宏，注意使用共享的内存
*/

#define	bn_512_l256(a)	(BN_256_ptr)(a+4)
