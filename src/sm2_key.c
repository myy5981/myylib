...
const BN_256 SM2_B				=	BN_256_INIT(28E9FA9E,9D9F5E34,4D5A9E4B,CF6509A7,F39789F5,15AB8F92,DDBCBD41,4D940E93);
...
void sm2_key_extend (SM2_PRI_KEY_EXT* kext, const SM2_PRI_KEY* prik){
