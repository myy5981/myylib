...
void sm2_point_dbl(JACOBIAN_POINT* r, JACOBIAN_POINT* a){
	BN_256_GFp_ptr x1=a->x;
	BN_256_GFp_ptr y1=a->y;
	BN_256_GFp_ptr z1=a->z;
	...
	//lambda_1
	bn_256_GFp_mul(la_1,z1,z1);
	bn_256_GFp_mul(la_1,la_1,la_1);
	bn_256_GFp_mul(la_1,la_1,SM2_A);
	bn_256_GFp_mul(la_2,x1,x1);
	bn_256_GFp_tri(tv,la_2);
	bn_256_GFp_add(la_1,la_1,tv);

	//lambda_2
	bn_256_GFp_sqr(la_2,y1);
	bn_256_GFp_mul(la_2,la_2,x1);
	bn_256_GFp_dbl(la_2,la_2);
	bn_256_GFp_dbl(la_2,la_2);

	//lambda_3
	bn_256_GFp_sqr(la_3,y1);
	bn_256_GFp_sqr(la_3,la_3);
	bn_256_GFp_dbl(la_3,la_3);
	bn_256_GFp_dbl(la_3,la_3);
	bn_256_GFp_dbl(la_3,la_3);
	...
	//z3
	bn_256_GFp_mul(z3,y1,z1);
	bn_256_GFp_dbl(z3,z3);
